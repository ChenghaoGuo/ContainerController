...
open class CollectionAdapterView: UICollectionView {
  ...
  public func registerIfNeeded(for item: CollectionAdapterItem) {
    register(item.cellClass, forCellWithReuseIdentifier: item.cellReuseIdentifier)
  }
